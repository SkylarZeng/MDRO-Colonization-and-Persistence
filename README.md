...
- longitudinal MDRO persistence and clearance analysis
- intervention-aware nursing home epidemiology workflows
...
This portfolio intentionally does not include the raw patient-level Pathways data tables that were used in the original internship analysis. Only code, visual outputs, and summary-safe aggregate tables are included here.
...
- This is a curated portfolio version of the internship folder, not a full research archive.
- Training certificates, administrative documents, and literature PDFs were not copied into this GitHub package.
- Some original file names and local paths are preserved because they document the working analysis context.
