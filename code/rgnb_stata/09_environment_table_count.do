...
merge 1:1 bucket_group_environment using `patient_table', nogenerate

// Export the combined table to a single CSV file
export delimited bucket_group_environment swab_count ctcr_swab_count cipr_swab_count imir_swab_count ///
